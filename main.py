...
def dashboard():
    if 'username' in session:
        ...
        response = make_response(render_template('dashboard.html', username=session['username'], rooms=user_rooms))
...
def chat(room_id):
    if 'username' in session:
        ...
        if room:
            return render_template('chat.html', room_id=room_id, room_name=room.get('room_name'), username=session['username'], messages=messages)
        else:
